...
**日本**：第Ⅰ部A-6で記述したとおり、1872年に学制が公布されました。1886年の小学校令により、義務教育の期間が定められます。就学率は、1900年代に90%を超えました [ [ 195 ] ](https://www.mext.go.jp/b_menu/hakusho/html/others/detail/1317552.htm) 。
...
第Ⅰ部A-6で記述したとおり、明治期の中央集権化において、学制は4つの機能の集約の1つでした。人事、財政、武力、そして人材規格です。教育制度は、この第4の機能を担いました。

ここで重要なのは、中段の設計が当時の条件下では有効に機能したという点です。識字率の向上、平均的な学力の底上げ、そして出身にかかわらず一定の教育を受ける機会の提供は、いずれもこの制度によって実現されました。

最下段の箱は、この設計が第Ⅰ部C-1で整理した4段階モデルのどこに位置するかを示します。教育制度は効果4、すなわち制度の変更にあたります。効果4は最も変化が遅い層であるため、上段の要請が変わっても設計は残り続けます。
...
3.  **現代社会の現状と課題**
    ...
    第Ⅲ部-4で述べるとおり、生成AIの導入は、技能の習得過程に影響しうることが観測されています。初級の作業を反復することによって技能を習得する経路が変化する場合、教育制度が前提としてきた学習の順序も再検討の対象になります。
