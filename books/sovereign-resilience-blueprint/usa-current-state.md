---
title: "第Ⅱ部A-6　アメリカの現在地 ―― 財政軌道と、合意形成の分断"
---
...
flowchart TD
    ...
    U --> F[制約1. 財政の軌道<br>2026年赤字 GDP比5.8％<br>市中保有債務 101％→2036年120％]
    U --> P[制約2. 合意形成の構造<br>権限が連邦と州に分散<br>予算成立に3者の同意が必要]

    F -->|利払費の増加| F2[歳出の裁量余地が縮小]
    P -->|多数派の周期的な変動| P2[政策の継続性が低下]
...
この図は、性質の異なる2つの制約を並べています。

制約1は、数量として測定可能です。債務残高の対国内総生産比が上昇すると、利払費が歳出に占める割合が増加します。利払費は削減の対象になりにくいため、その他の歳出項目の裁量余地が縮小します。

制約2は、数量では表せません。ただし、その帰結は観測可能です。政権や議会多数派が交代するたびに、前政権の政策が撤回または変更される頻度として現れます。

日本にとって重要なのは、制約2の帰結です。同盟関係に基づく政策は、複数年にわたる継続を前提とします。相手方の政策継続性が低下する場合、その前提の確実性が低下します。
