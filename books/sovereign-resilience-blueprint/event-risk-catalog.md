...
各区分が、どの供給基盤に作用するかを示します。

```mermaid
flowchart TD
    A[区分A. 進行中の変化<br>人口 財政 設備劣化 AI 気候]
    B[区分B. 不連続な事象<br>輸送路 地震 攻撃 情報 暗号 感染症]

    A -->|余力の逓減| S[社会の応答能力]
    B -->|衝撃の入力| S
    S -->|余力が衝撃を上回る場合| R1[吸収され 通常の運用へ復帰]
    S -->|衝撃が余力を上回る場合| R2[機能の縮退が長期化]
...
この図は、第Ⅰ部A-6で整理した崩壊の構造を、現在の日本に適用したものです。

区分Aは、内部条件の変化です。これらは衝撃を与えるのではなく、衝撃を吸収する余力を逓減させます。

区分Bは、外部からの衝撃です。B-1からB-6までの6つの事象は、いずれも発生時期を特定できません。
