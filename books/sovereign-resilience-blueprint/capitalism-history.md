...
```mermaid
flowchart TD
    A["段階1. 直接交換<br>欲望の二重の一致が必要<br>交換比率は n(n-1)/2 通り"]
    A -->|売却しやすい財への需要集中| B[段階2. 交換媒介の獲得<br>特定の財が媒介として定着<br>必要な価格は n 個へ削減]
    B -->|比較不能なものの共通単位化| C[段階3. 価値尺度の確立<br>労働・土地・知識・時間を<br>単一の数直線へ写像]
    C -->|物理的裏付けの切り離し| D[段階4. 完全な非実体化<br>1971年 金兌換停止<br>信認と法制度のみが価値を支える]
...
この図が示しているのは、貨幣の歴史が「実体からの離脱」の過程であったという構造です。

段階1から段階2への移行では、貨幣はまだ実体を持つ財でした。金属としての価値、あるいは装飾品としての価値が、受け取る理由を支えていました。

段階3において、貨幣の役割が変質します。ここで貨幣が担うのは、比較不能なものを比較可能にする変換装置としての機能です。1時間の労働と、1平方メートルの土地と、1件の特許と、1年後の受け取りの権利。これらは物理的には共通点を持ちません。しかし貨幣建てに変換された瞬間、これらは同一の数直線上に並び、加減算が可能になります。

段階4は、この変換装置から物理的な裏付けを取り除いた状態です。

ここで重要な逆説があります。貨幣は、実体を失うほど汎用性を増しました。金という実体に縛られている間、通貨の供給量は金の産出量に制約されていました。実体から切り離されたことで、この制約は解除されます。

すなわち、貨幣が「それ自体としては何の価値も持たない」という性質は、欠陥ではありません。あらゆる価値を受け入れる空の器であることが、汎用の共通言語として機能するための条件です。次章では、この性質が、なぜ他の資源配分方式による代替を困難にしているかを検討します。
