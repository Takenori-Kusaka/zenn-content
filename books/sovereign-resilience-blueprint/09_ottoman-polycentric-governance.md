...
```mermaid
flowchart TD
    A[段階1. 多元共存の慣行<br>宗教共同体ごとの一定の自律<br>人頭税と法的地位の差異を伴う]
    A -->|西欧諸国からの圧力と近代化の要請| B[段階2. 均質化の試み<br>タンジマート 1839年 1856年<br>宗教によらない臣民の平等を宣言]
    B -->|民族を単位とする帰属意識の拡大| C[段階3. 分離独立の連鎖<br>ギリシャ セルビア ルーマニア<br>ブルガリアの独立]
    C -->|バルカン戦争と第一次世界大戦| D[段階4. 帝国の解体<br>1922年スルタン制廃止<br>1923年トルコ共和国成立]
...
この図で注意すべきは、段階2と段階3の関係です。

タンジマートの改革は、宗教による差異を撤廃し、共通の臣民資格を確立するものでした。その意図は、帝国の統合を強化することにありました。

一方、同時期に進行したのは、民族を単位とする帰属意識の拡大と、それに基づく分離運動でした。

この2つの時間的な重なりについては、改革が分離を促進したという解釈も提示されています。しかし、この因果を確立した事実として扱うことはできません。同時期には、西欧諸国による干渉、経済的な条件の変化、教育の普及など、複数の要因が並行して作用していました。

本書が事実として記述するのは、次の点にとどまります。すなわち、宗教を単位とする統治から、共通の臣民資格へ転換しようとした時期と、民族を単位とする分離運動が拡大した時期とが重なっているという時系列上の対応です。

第Ⅰ部A-6で整理する枠組みに照らせば、この経過は正統性の供給源の転換として理解できます。帝国への帰属を支えていたのは、宗教共同体を通じた間接的な関係でした。この関係を臣民資格という直接的な関係へ置き換えようとした局面で、別の帰属、すなわち民族への帰属が正統性の供給源として台頭しました。
...
1.  **現代社会構造の原点**
    ...
    重要なのは、この構成が普遍的に優れているから採用されたのではないという点です。当時の国際環境において、この構成を持つ国家が交渉と軍事の両面で優位を示したため、他の国家もこれに追随しました。第Ⅰ部A-5で記述する明治日本の中央集権化も、同じ文脈に位置します。
...
3.  **現代社会の現状と課題**
    ...
    第一の論点は、第Ⅴ部の設計に接続します。局所の裁量を残したまま全体の整合性を確保する構成は、統一的な規則によらずとも成立しうる、ということです。ただし、その成立には条件があります。条件については、第Ⅳ部-2で参照する共有資源の管理に関する研究を用いて検討します。

    第二の論点は、第Ⅲ部の議論に接続します。現代の統治において正統性を供給しているのは、選挙による同意と手続の遵守です。第Ⅳ部-1で述べるとおり、この供給源に変化が生じうる状況にあります。本章の事例が示すのは、この転換期が構造的に不安定であるということです。
