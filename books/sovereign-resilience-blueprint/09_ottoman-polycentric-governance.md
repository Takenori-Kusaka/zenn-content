...
下段の合流は、2つの動きの帰結が同じ地点に至ったことを表します。第Ⅰ部A-8で整理する枠組みに照らせば、この経過は正統性の供給源の転換として理解できます。宗教共同体を通じた間接的な関係を臣民資格という直接的な関係へ置き換えようとした局面で、民族への帰属が第三の供給源として台頭しました。
...
1.  **現代社会構造の原点**
    ...
    重要なのは、この構成が普遍的に優れているから採用されたのではないという点です。当時の国際環境において、この構成を持つ国家が交渉と軍事の両面で優位を示したため、他の国家もこれに追随しました。第Ⅰ部A-6で記述する明治日本の中央集権化も、同じ文脈に位置します。
