...
第Ⅲ部-6で述べるとおり、有事において複雑な判断を要求する設計は、実際には機能しにくくなります。判断に要する注意という資源が、最も逼迫する局面だからです。したがって、有事の動作は事前に定めておく必要があります。
...
3.  **現代社会の現状と課題**
    ...
    第Ⅲ部-12で整理する分岐条件のうち、制度の追随速度は、この問題に直結します。人間の判断をどの層に配置するかを事前に設計できるかどうかが、応答の可否を分けます。
