...
```mermaid
flowchart TD
    T1[要素1. 検知<br>技術により短縮されてきた]
    T1 --> T2[要素2. 伝達<br>技術により短縮されてきた]
    T2 --> T3[要素3. 判断<br>人間の生理的な下限が存在]
    T3 --> T4[要素4. 実行<br>技術により短縮されてきた]
    T4 -->|要素3の比率が上昇| R[帰結. 人間の判断が制約となる<br>事前の条件設定へ役割が移行]
...
この図が示すのは、人間の役割の変化が、能力の劣位によってではなく、他の要素の短縮によって生じるという点です。

要素3の絶対時間は変化していません。変化したのは、要素1、2、4が短縮されたことで、要素3が全体に占める比率です。

この構造は、本書の他の箇所にも現れます。第Ⅰ部C-12で整理した職能の置換においても、人間の能力が低下したのではなく、周囲の要素が速くなったことで相対的な位置が変わりました。

帰結として示した「事前の条件設定へ役割が移行する」という点は、本書全体の設計論に接続します。
