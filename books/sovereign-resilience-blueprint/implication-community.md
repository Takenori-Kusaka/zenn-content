...
第Ⅲ部-9で述べたとおり、人口密度の低下は不均等に進行します。集約型インフラが維持される区域と、そうでない区域とが併存します。

後者において、地域社会に期待される機能は前者より大きくなります。この差は、地域間の格差として現れます。

**推論3：関係の再構築には時間がかかります**

第Ⅲ部-5で整理した心理的な条件は、地域の関係にも作用します。近隣との関係の構築と維持には、認知的な負荷が伴います。この負荷は、必要が生じていない時点では回避されます。
...
第Ⅲ部-5で述べた設計の方向性が、ここでも適用されます。すなわち、判断の主体を各人に残したまま、そのための手間を減らす設計です。
...
地域社会に期待される機能を、必要な条件の重さによって並べます。

```mermaid
flowchart TD
    L1[階層1. 災害直後の相互援助<br>安否確認 初期救助 物資の融通<br>条件：比較的自発的に成立]
    L1 -->|期間の長期化| L2[階層2. 復旧期の共同運用<br>避難所の運営 情報の共有<br>条件：役割分担と記録が必要]
    L2 -->|平時への組み込み| L3[階層3. 供給の共同維持<br>電源 水 通信の共同管理<br>条件：規則 監視 制裁 紛争解決]
...
階層2は、期間が長期化した場合に必要となります。ここでは役割の分担と記録が要求されます。多くの自治体において、この階層の準備は訓練として実施されています。
...
なお、階層3が必要となるのは、集約型インフラが維持されない区域です。維持される区域において階層3を求める必要はありません。この点で、期待される機能は地域の条件に依存します。
