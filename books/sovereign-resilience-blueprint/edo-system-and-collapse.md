---
title: "第Ⅰ部A-4　江戸幕藩体制 ―― 分権統治の成立と、外部衝撃による解体"
---
...
分権構造がどの経路をたどって中央集権構造へ転換したかを、垂直フローで示します。

```mermaid
flowchart TD
    A[1. 分権的な統治構造の確立<br>藩ごとの徴税権と司法権<br>幕府は外交と貨幣を独占]
    A -->|米建て歳入と貨幣建て支出の乖離| B[2. 財政基盤の劣化<br>改鋳の反復と3度の改革<br>上知令の撤回で調整能力が露呈]
    B -->|1853年 ペリー来航| C[3. 外部衝撃の到来<br>条約体制への編入<br>関税と裁判権の制約]
    C -->|勅許を得ない条約締結| D[4. 統治正統性の争点化<br>朝廷の権威を掲げる勢力の台頭]
    D -->|大政奉還 / 戊辰戦争| E[5. 中央集権機構への転換<br>版籍奉還と廃藩置県]
...
この図は、2つの独立した要因が合流する構造を示しています。

上段に位置する1から2の系列は、内部要因です。歳入の算定基準と支出の建て値とが乖離し、財政調整能力が低下していく過程を表します。この劣化は、外部との接触がなくとも進行していました。

3で加わるのが外部要因です。ペリー来航と条約締結は、幕府の内部事情とは独立した事象でした。

注目すべきは、4の段階です。ここで発生したのは、財政問題ではなく、軍事的敗北でもありません。統治の正統性が争点化したという、性質の異なる問題です。条約の締結に勅許を得られなかったことにより、幕府が最終的な決定権を持つという前提そのものが、公然と否定されました。

内部の劣化と外部の衝撃とが、正統性という接点で結合したこと。これが、5への移行を可能にした構造です。
