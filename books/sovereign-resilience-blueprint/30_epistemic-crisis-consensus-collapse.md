...
この図は、左側に上から下へ3段の連鎖があり、右側の1つの条件と合わせて、最下段の1つの帰結へ集まる形をしています。ただし、この連鎖は本書による整理であり、4者がこの順序で相互に参照しているわけではありません。

左側の3段は、共通の前提が失われる過程です。情報の流通が増大し、個人ごとに異なる情報が提示され、判断の前提となる基盤が失われます。

右側のフクヤマの分析は、この過程とは独立した制度的な条件です。決定を阻止する権限が分散していれば、決定は実行に至りにくくなります。

重要なのは、最下段です。第Ⅰ部B-4で述べたとおり、民主的な意思決定は参加者が共通の事実を前提とすることを条件とします。左側の3段は、この条件を損ないます。そこに右側の制度的な条件が重なると、決定そのものが成立しなくなります。
