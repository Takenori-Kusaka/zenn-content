...
```mermaid
flowchart TD
    A[1854年 スノウの調査<br>水系伝播の統計的な確認<br>病原体は未特定]
    A -->|給水元による死亡率の差を提示| B[1855年 調査結果の公刊<br>2つの給水会社の比較]
    B -->|1858年 テムズ川の汚染が議会で問題化| C[1858年以降 下水道の建設<br>遮集管渠による下流への導水]
    C -->|1875年 公衆衛生法| D[全国的な整備義務<br>地方当局に下水道の責任]
    D -->|1883年| E[病原体の確立<br>対策の実施から約25年後]
    ...
    style E fill:#0f3d2e,stroke:#10b981,color:#ecfdf5
```

#### 図の読み方

この図が示すのは、有効な対策が原因の完全な理解に先行したという点です。

スノウの調査は、病原体を特定していません。特定したのは、給水元と死亡率との対応関係です。

第二の調査は、方法論として重要です。同一地区に2つの給水会社が混在していたという偶然の条件が、他の要因を一定に保った比較を可能にしました。

対策の実施も、原因の解明に先行しました。1858年に下水道整備が決定された直接の契機は、統計的な証拠ではなく、議会周辺における悪臭です。それでも、実施された対策は結果として有効でした。
