...
```mermaid
flowchart TD
    P1[段階1. 西方への拡大期<br>1803年ルイジアナ購入から<br>1848年の領域確定まで]
    P1 -->|統治機構の整備が追随せず| P2[段階2. 法の空白地の発生<br>自警組織と鉱山規約による<br>自生的な秩序形成]
    P2 -->|1890年 国勢調査局の報告| P3[段階3. フロンティアの消滅<br>境界線を引けない状態と判定]
    P3 -->|拡大方向の転換| P4[段階4. 対外進出と国内の摩擦<br>領有の拡大 労働争議 移民制限の拡大]
...
この図は、事実の時系列を4段階に整理したものです。段階間の因果関係については、注意が必要です。

段階1から段階2への関係は、比較的直接的です。統治機構の整備が領域の拡大に追随しなかったという事実から、法執行の不在が生じました。

段階2で観測された自生的な秩序形成は、本書の議論にとって重要です。中央の法執行が存在しない状態において、利用者集団が自ら規約を制定し、監視と制裁の仕組みを設けた事例が記録されています。この構造は、第Ⅳ部-2で参照する共有資源の管理に関する研究が抽出した条件と部分的に重なります。

段階3から段階4への関係については、ターナーの学説がそれを因果として提示しました。ただし前節で述べたとおり、この学説には複数の批判があります。

したがって本書は、段階4で観測された事象、すなわち対外領有の拡大、労働争議の頻発、移民制限の立法を、事実として記述するにとどめます。それらがフロンティアの消滅によって引き起こされたという因果の主張は、確立した事実としては扱いません。
...
3.  **現代社会の現状と課題**
    ...
    第一の論点は、第Ⅳ部-2および第Ⅴ部に接続します。集約型インフラが維持されない区域において、利用者集団による共同管理が成立しうるかという問いです。本章の事例は、成立の条件として集団規模の限定と制裁の実効性を示唆します。

    第二の論点は、第Ⅲ部の議論に接続します。日本において、人口の減少と経済規模の縮小は、拡大の余地の喪失に相当します。この局面において内部の分配をめぐる対立が顕在化しうるかどうかは、第Ⅲ部-11で扱う悲観シナリオの一要素です。
