...
左右の箱が合流する下段の経路1が、本書の当面の設計です。その下に破線で示した経路2は、本書の範囲を超えます。ただし、第Ⅱ部A-4で示した水道管路の更新期と、第Ⅱ部A-5で示した居住の分化を考慮すれば、次の必要は今後高まると考えられます。集約型の維持範囲の外側における供給形態を、制度が位置づけることです。
---
