...
```mermaid
flowchart TD
    A[段階1. 総力戦の成立<br>後方の生産能力が戦力に組み込まれ<br>攻撃対象が社会全体へ拡大]
    A -->|破壊の規模が政治目的を超過| B[段階2. 核兵器の登場<br>単一の攻撃で都市規模の破壊<br>勝利の概念が成立しにくくなる]
    B -->|使用しないことが目的化| C[段階3. 抑止体制の形成<br>報復能力と意思の信憑性が要件]
    C -->|規範の成文化| D[段階4. 条約による制約<br>不拡散 / 実験禁止<br>民用物と生存基盤の保護]

    style A fill:#3f1d1d,stroke:#dc2626,stroke-width:2px,color:#fef2f2
...
この図が示しているのは、制約が技術に先行せず、常に事後的に整備されるという構造です。

段階1で生じた事態、すなわち民間人と生産設備が攻撃対象となったことに対し、規範が整備されたのは段階4、1949年および1977年でした。総力戦の経験から30年以上を要しています。

段階2で重要なのは、破壊力の増大が政治目的との関係を変えた点です。第Ⅰ部D-1で参照したクラウゼヴィッツの定式によれば、戦争の規模は政治目的の大きさに規定されます。しかし核兵器の破壊規模は、通常の政治目的が要求する規模を超過します。目的を達成するために用いる手段が、目的そのものを無意味にするという構造です。

この構造が、段階3の抑止体制を導きました。抑止とは、能力を保有しながら行使しない状態を安定的に維持する設計です。

段階4の条約体系のうち、第54条と第56条は本書の議論において重要です。これらは、食糧、飲料水の施設、ダム、そして原子力発電所を保護対象と規定しています。すなわち、生活基盤への攻撃が実際に発生しうるという想定のもとで整備された規定です。
