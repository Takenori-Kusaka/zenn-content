...
第Ⅱ部D-6で記述したとおり、広域網の途絶は日常的な作業の誤りからも生じます。本章は、その期間に第Ⅴ部-7の第1層と第2層の間で情報を交換する手段を扱います。
...
前節の無線方式を日本で運用する場合、日本向けの周波数と出力の規定に適合した機器を用いる必要があります。この点は、第Ⅴ部-3で述べた原則7、すなわち制度との整合に対応します。
...
最下段の箱に示した情報の性質が重要です。この構成で伝えられるのは、安否、位置、設備の状態、そして短い連絡です。第Ⅴ部-3の原則4に対応する監視の記録、たとえば蓄電の残量や水の処理状況は、この範囲に収まります。

したがって、本章の構成は広域網の代替ではありません。途絶時において、第Ⅴ部-7の第2層の範囲で、共同管理に必要な最小限の情報を交換する手段です。

第Ⅲ部-9で述べたとおり、供給の停止と情報の混乱が重なる状況において、近隣の状況を確認できることが対応の前提となります。本章の構成は、その前提を局所で維持するためのものです。
---
...
3.  **現代社会の現状と課題**
    ...
    本章の構成は、第Ⅴ部-14から第Ⅴ部-16で扱った計算基盤、記録、判断支援と組み合わされて機能します。次章では、これらを含む第Ⅴ部の設計要件を総括します。
