...
第Ⅰ部A-8で参照した4つの研究は、いずれも同じ方向を示しました。イブン・ハルドゥーンの連帯意識の減衰、テインターの限界収益逓減、ターチンらのエリート過剰生産と実質賃金の低下、そしてアセモグルらの制度の性質です。
...
**推論A：日本は、第Ⅰ部A-8の枠組みにおける段階2の末期から段階3への移行期に位置している**
...
第Ⅰ部A-8で整理したとおり、限界点の指標は水準ではなく応答特性の変化です。ただし、その変化を事前に検知する手法を、本書は提示できていません。
