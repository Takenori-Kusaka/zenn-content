...
flowchart TD
    D[災害の発生]
    D -->|数時間から数日| A[自発的な相互援助<br>救助 炊き出し 避難所 物資分配<br>公式の指揮系統によらず組織される]
    A -->|当局の到着| B[当局との関係<br>統制の優先による対立が生じた事例]
    A -->|数週間以降| C[同書の対象外<br>長期にわたる共同管理には<br>別の条件が必要]
...
この図が示すのは、同書の観測が時間軸の特定の範囲に限られるという点です。

Aの段階における観測は、本書にとって重要です。第Ⅲ部-6で整理した心理的な条件、すなわち判断の負荷が高い選択は選ばれにくいという傾向は、災害直後には異なる形で現れます。同書の観測によれば、この段階では相互援助が自発的に生じています。

Bの段階は、設計上の教訓を含みます。当局の想定と住民の行動との乖離は、事前の計画が実際の行動を前提としていなかったことを示します。

Cの段階が、本書の主要な関心です。第Ⅴ部-2で整理したとおり、長期の共同管理には8つの設計原則を満たす制度が必要です。災害直後の相互援助は、その条件なしに生じます。しかし、それが持続するとは限りません。
