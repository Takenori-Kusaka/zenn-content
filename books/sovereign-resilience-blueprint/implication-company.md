...
現在、企業の主要な評価指標は、売上高、利益率、そして資本効率です。[第Ⅰ部B-2](capitalism-history)で整理したとおり、これらはいずれも貨幣建ての指標であり、比較不能なものを比較可能にする変換装置を経由しています。
...
[第Ⅰ部B-3](capitalism-why-irreplaceable)で整理したとおり、価格機構は、貨幣建てに変換できない情報を構造的に無視します。この無視が許容されるのは、無視される部分が小さい場合に限られます。

### 2. 条件の変化に関する推論

前節の3条件は、[第Ⅱ部](japan-current-state)で確認した現状において、次のような圧力を受けています。

**条件2に対する圧力**

[第Ⅱ部B](report-ukraine-war)で整理したとおり、供給基盤を攻撃対象とし、輸送路を制約する事例が観測されています。
...
[第Ⅲ部-4](risk-ai-and-dependency)で述べたとおり、生成AIの導入が技能の習得過程に影響する場合、企業にとって短期的には費用の削減となる一方、中期的には自らの供給能力を損なう可能性があります。この時間差が、価格に反映されにくい構造を作ります。
...
[第Ⅰ部B-3](capitalism-why-irreplaceable)で整理したとおり、貨幣という共通単位を代替する仕組みは、現時点で存在しません。したがって、貨幣建ての評価が放棄されることは考えにくいと言えます。
...
この2条件は、[第Ⅴ部](42_taoist-wu-wei-non-action)で扱う具体的な設計の要件となります。
...
[第Ⅰ部B-5](socialism-communism-history)で整理した計画経済の分析が、ここで再び有効です。そこで観測された不具合は、指導者の資質ではなく誘因の構造に起因していました。同じ論理が、ここにも適用されます。
...
1.  **本章が主張しないこと**
    ...
    本章は、利益の追求が誤りであるとは主張しません。[第Ⅰ部B-2](capitalism-history)および[第Ⅰ部B-4](democracy-history)で整理したとおり、貨幣建ての評価は、比較不能なものを比較可能にする有効な仕組みです。
