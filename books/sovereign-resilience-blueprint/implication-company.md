...
現行の指標と、追加されうる指標の時間軸を並べます。

```mermaid
flowchart TD
    E[企業の評価]

    E --> S[短期指標<br>売上 利益率 資本効率<br>測定周期：四半期から年次]
    E --> M[中期指標<br>技能の継承 供給元の分散<br>測定周期：数年]
    E --> L[長期指標<br>環境負荷 地域の維持<br>測定周期：数十年]
...
3つの指標は、いずれも重要性が認識されています。問題は、測定周期の差により、資源配分の判断において短期指標が優先されることです。
...
その誘因を作る方法は3つあります。制度による義務づけ、取引先や資金提供者による要求、そして市場における評価です。いずれも外部からの作用であり、企業内部の意識の変化に依存しません。
