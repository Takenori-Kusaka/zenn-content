...
flowchart TD
    Q[利用者の問い]
    Q --> S[局所の記録を検索<br>第Ⅴ部-16の<br>署名つき記録が対象]
...
左の経路の最下段の出力は、第Ⅲ部-5で述べた経路2、すなわち道具としての利用に対応します。判断の主体は利用者に残り、モデルは根拠つきの案を提示するに留まります。

右の破線の経路は、第Ⅴ部-9の方向2に対応する手動経路です。モデルが停止しても、記録への到達は失われません。
