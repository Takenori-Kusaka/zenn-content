...
第Ⅰ部A-6で整理したとおり、近代日本の中央集権化は4つの機能の集約として実施されました。人事、財政、武力、そして人材規格です。
...
第Ⅰ部A-8の枠組みでは、正統性が争点化しない限り段階4には至らないと整理しました。この枠組みに従う限り、余力の逓減は縮退として処理されます。ただし、これは枠組み内の含意であり、正統性の供給が崩壊を防ぐ十分条件であると主張するものではありません。
...
第Ⅰ部A-6で整理した4機能の集約に照らせば、これらの変化はいずれも集約の解体ではありません。集約された機能を、どの水準でどう提供するかの再定義です。
