...
**安全の保証**：第Ⅱ部B-1および第Ⅲ部-6で整理したとおり、武力紛争が長期化した場合、攻撃対象は供給基盤へ拡大します。この場合、安全の保証と供給の保証は分離できません。
...
**判断の代行**：第Ⅲ部-4で整理したとおり、専門的な判断を支援する技術が普及した場合、国家が判断を代行する必然性が低下します。同時に、代行の対象が民間の事業者へ移動する可能性があります。
...
第Ⅲ部-4で述べたとおり、判断を支援する技術が普及すると、個人が直接に判断材料を得られるようになります。
...
1.  **本章の推論の限界**
    ...
    第Ⅲ部-4で整理した心理的な条件に照らせば、期待の変化は容易には生じません。現状維持が選ばれやすく、認知的な負荷の低い選択が優先されるためです。
