...
flowchart TD
    ...
    Q --> L1[供給源1. 伝統と血統<br>王政 / 貴族制<br>「以前からそうであった」]
    Q --> L2[供給源2. 個人の資質<br>カリスマ的支配<br>「その人物だから」]
    Q --> L3[供給源3. 手続きと規則<br>法治国家 / 官僚機構<br>「規則に沿っているから」]
    Q --> L4[供給源4. 構成員の同意<br>共和制 / 民主主義<br>「自分たちで決めたから」]
...
この図は、統治形態を支配者の数ではなく、正統性の調達経路によって配置したものです。供給源1から3はウェーバーの類型に対応し、供給源4は本書が節4の社会契約論の系譜から独立の区分として追加したものです。

この配置を採る理由は、第Ⅰ部Aで記述したオスマン帝国と江戸幕府の崩壊事例が、いずれも正統性の争点化を通じて発生したためです。したがって、統治形態を比較するにあたっては、それぞれがどこから正統性を調達しているのか、そしてその供給源がどのような条件で枯渇するのかを見る必要があります。

供給源1（伝統と血統）は、供給が安定している一方、更新の手段を持ちません。血統の断絶や、伝統そのものへの疑義が生じた場合、代替の供給源がありません。

供給源2（個人の資質）は、供給の強度が最も高い一方、供給者の寿命に依存します。

供給源3（手続きと規則）は、供給が形式化されているため安定します。ただし、手続が遵守されていても結果が受け入れられない場合、供給が機能しません。

供給源4（構成員の同意）は、周期的な更新が可能です。ただし、更新には時間と費用がかかります。この更新周期と、外部環境の変化速度との関係が、第Ⅲ部の主要な論点の1つとなります。

なお、現実の統治機構は、これらを単独で用いることは稀です。複数の供給源を組み合わせ、1つが弱まった際に他が補完する構造を持ちます。
...
3.  **現代社会の現状と課題**
    ...
    もう1つは、手続きの自動化です。行政の決定過程がアルゴリズムに委ねられる度合いが高まると、手続きの遵守という事実は保たれても、その手続きの内容を構成員が検証できなくなります。この論点は、第Ⅱ部で扱います。
