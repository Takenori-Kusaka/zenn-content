...
下段の右が、本書にとって重要です。行政手続には決定の根拠を開示し不服を申し立てる制度がありますが、開発主体の判断について同等の手続は保証されていません。第Ⅲ部-4で整理する依存対象の移行は、この手続の空白の中で進行します。
...
3.  **現代社会の現状と課題**
    ...
    第Ⅲ部-10で整理する指標のうち、判断の根拠を提示する設計の実装状況は、この空白の縮小を測る指標にあたります。
