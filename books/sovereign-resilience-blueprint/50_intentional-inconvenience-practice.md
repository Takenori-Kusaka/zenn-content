...
枠内の最下段の方向3は、効果が最も大きい一方、実現が最も困難です。第Ⅲ部-6で述べた負荷の非対称が、ここでも作用します。したがって方向3は、利用者の意思に委ねるのではなく、設備の運用に組み込まれる形でのみ持続します。枠の下に付いた箱が、その条件です。たとえば、蓄電池の保守のために定期的に系統から切り離す運用は、方向3を保守という別の目的に埋め込んだ構成です。
