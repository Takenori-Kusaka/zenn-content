...
flowchart TD
    ...
    P1 -->|配分の偏りが顕在化| P2[局面2. 抵抗<br>賃率と職業慣行の維持<br>争点は技術ではなく条件]
    P2 -->|技能構成の入れ替わり| P3[局面3. 再編<br>職種の帰趨が分かれる]
    P3 -->|費用低下が需要を拡大| K[職種は維持<br>銀行窓口 総数は減らず]
    P3 -->|需要が拡大しない| L[職種は消滅<br>手織工 馬車 交換手]
    K --> P4[局面4. 再配分<br>教育 労働法規 分配制度<br>実質賃金の上昇を観測]
    L --> P4
    ...
    style L fill:#3f1d1d,stroke:#dc2626,color:#fef2f2
    style P4 fill:#0f3d2e,stroke:#10b981,color:#ecfdf5
```

#### 図の読み方

この図は上から下へ時系列として読みます。3段目の局面3だけが左右に分かれ、最下段で再び1つに合流します。前章の4段階モデルを、労働の側から見たものです。

最上段の局面1で観測されるのは、生産性と実質賃金の乖離です。アレンの分析が示したとおり、産業革命期にはこの乖離が約50年続きました。

2段目の局面2で発生するのは、抵抗です。ここで重要なのは、抵抗の争点が技術そのものではなく、導入の条件であったという事実です。ラッダイト運動の要求内容は、賃率と徒弟制度の維持でした。

3段目の局面3において、職種の帰趨が分かれます。分岐の条件は矢印に記したとおり、費用の低下が需要の拡大を生むかどうかです。左の箱の銀行窓口の事例では需要が拡大し、総量が維持されました。右の箱の手織工の事例では、そうなりませんでした。

最下段の局面4で、制度が追随します。実質賃金の上昇が観測されるのは、この局面です。左右どちらの経路をたどった職種も、この局面に合流します。

本書にとって重要なのは、最上段から最下段までの所要時間です。過去の事例では、この期間は数十年に及びました。この期間、局面2で抵抗した層と、局面3で右の箱に入った層は、局面4の恩恵を自らの職業人生の中で受け取れませんでした。
...
3.  **現代社会の現状と課題**
    ...
    [第Ⅲ部](future-method)では、この論点を具体的なシナリオとして扱います。
