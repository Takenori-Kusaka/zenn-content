...
```mermaid
flowchart TD
    A[2050年推計<br>1km区画の51％で人口が半減<br>居住区画の18.7％は無居住化]
    A -->|人口が維持される区画| B[集中する区域<br>大都市圏と地方都市の中心部]
    A -->|人口が半減する区画| C[縮小する区域<br>地方の周縁部]
    B -->|制度的対応| D[立地適正化計画<br>居住と機能を誘導区域へ集約]
    C -->|制度的対応| E[過疎対策<br>減少地域の生活維持を支援]
...
この図が示すのは、人口減少が一様な縮小ではなく、分化として進行するという点です。

全国の総人口が減少する中で、区画によっては人口が増加します。逆に、居住者がいなくなる区画も相当数に上ります。全国平均の統計では、この差が見えにくくなります。

分化の帰結として、供給インフラの条件も分化します。第Ⅱ部A-4で示した更新期の施設は、集中する区域と縮小する区域の双方にあります。前者では利用者密度が維持され、後者では低下します。同じ施設であっても、1人あたりの維持費用は大きく異なります。

2つの制度的対応は、それぞれの区域に対応しています。ただし、いずれも既存の供給方式を前提としています。すなわち、集約型のインフラをどの範囲で維持するかという問いへの回答であり、集約型以外の方式については扱っていません。
