...
上段の問いは、左列と右列の2つの方向に分かれます。左列は作為による秩序であり、第Ⅰ部A-6で記述した中央集権化と、第Ⅱ部C-7で記述した統合管理の系譜にあたります。右列は作為の抑制であり、左列に対する対抗軸です。
...
3.  **現代社会の現状と課題**
    ...
    第Ⅴ部-8で扱う能動的不便の実践は、本章の思想を日常の設計に翻訳したものです。第Ⅲ部-5で整理したとおり、負荷の高い選択は選ばれにくいため、翻訳には設計上の工夫を要します。
