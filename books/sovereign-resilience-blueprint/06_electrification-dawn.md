...
同時に、逆の含意もあります。最上段の制約が変われば、その下の帰結も変わりうるということです。[第Ⅴ部](42_taoist-wu-wei-non-action)では、この点を検討します。
...
3.  **現代社会の現状と課題**
    ...
    [第Ⅴ部](42_taoist-wu-wei-non-action)では、変化した制約と変化していない制約とを区別したうえで、局所的な供給がどこまで成立するかを検討します。
